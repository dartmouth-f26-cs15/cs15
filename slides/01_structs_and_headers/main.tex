...
\begin{frame}[fragile]{Activity \#1.4: Your First Header File}
    \begin{itemize}
        ...
        \pause \item Then, instruct the preprocessor to paste its contents into \textpf{main.c} by sticking \textpf{\#include "my\_math.h"} at the top of \textpf{main.c} and \textpf{my\_math.c}.
        \pause \item Why is it important to put this \textpf{\#include} in \textpf{my\_math.c} as well? % Because then the compiler will error when the declarations get out of sync with the definitions
    \end{itemize}
\end{frame}
